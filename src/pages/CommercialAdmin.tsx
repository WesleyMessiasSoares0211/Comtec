...
import { 
  ...
  PackageSearch, AlertTriangle, Lock, FileText,
  Search, Download, CalendarClock, ChevronLeft, 
  ChevronRight, User, Mail, Phone, Edit2, Trash2
} from 'lucide-react';
...
export default function CommercialAdmin() {
  ...
  const handleTabChange = (tab: string) => {
    ...
    if (tab === 'clientes') {
      ...
      setViewingClient(null); // MODIFICACIÓN: Resetear vista al cambiar pestaña
    }
    if (tab === 'productos') {
