...
interface UseAuthReturn {
  ...
  canEdit: boolean;
  canCreate: boolean;
  canManageProducts: boolean; // <--- NUEVO PERMISO ESPECÍFICO
}
...
export function useAuth(): UseAuthReturn {
  ...
  // NUEVA REGLA: Solo Admins y Super Admins pueden tocar el catálogo
  const canManageProducts = isSuperAdmin || isAdmin;

  return {
    session, profile, role, loading, error, isAuthenticated,
    isSuperAdmin, isAdmin, isVendedor, isTecnico,
    canDelete, canEdit, canCreate, canManageProducts
  };
}